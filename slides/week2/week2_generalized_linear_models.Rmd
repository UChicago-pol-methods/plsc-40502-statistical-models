...
$$Var(\hat{\theta}) = \frac{1}{n}\bigg[\mathbf{E}[-\ell^{\prime\prime}(\theta_0|\mathbf{y})]\bigg]^{-1}\bigg[Var(g_i(Y_i|\theta_0))\bigg]\bigg[\mathbf{E}[-\ell^{\prime\prime}(\theta_0|\mathbf{y})]\bigg]^{-1}$$
...
$$\widehat{Var(\hat{\theta})} = \frac{1}{n}\bigg[-\frac{1}{n}\sum_{i=1}^n h_i(Y_i|\hat{\theta})\bigg]^{-1}\bigg[\frac{1}{n}\sum_{i=1}^n g_i(Y_i|\hat{\theta})  g_i(Y_i|\hat{\theta}) ^{\prime}\bigg]\bigg[- \frac{1}{n} \sum_{i=1}^n h_i(Y_i|\hat{\theta})\bigg]^{-1}$$
