...
```{r, message=F, fig.align="center", fig.width=7, fig.height=5}
library(bayesplot)
mcmc_areas(as.matrix(model_fit), pars = c("beta[2]"))
```
...
```{r, fig.align="center", fig.height=6, fig.width=8, warning=F}
bayesplot::ppc_dens_overlay(y = elections_county$dem2018, yrep = y_ppc)
```
