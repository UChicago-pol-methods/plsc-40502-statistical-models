...
- We want to write the likelihood as a density in $\beta$. Expand the quadratic form, drop terms that only contain $Y$ and use the fact that $\Sigma^{-1}$ is symmetric.
