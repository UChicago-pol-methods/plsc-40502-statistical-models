...
\published{{\sffamily Winter 2023 | Lecture: Tues./Thurs.,  2:00pm-3:20pm, | Room: Hinds 184 (Lecture) | Units: 100}}
...
\begin{itemize}
	...
	\item \textbf{March 9th: Final paper due}. You will submit the final paper as well as a replication archive containing your data and code to the Canvas website.
	\end{itemize}
...
The goal of the problem sets is to encourage exploration of the material and to provide you with a clear and credible means of assessing your understanding and progress through the course. As such, problem sets are \textit{designed} to be challenging and I expect students to find some questions difficult. Because problem sets are mainly a tool for communication between the me and you, they will not be graded in the usual fashion.
...
\item ``Bayesian Data Analysis`` Chapter 5, 15
\end{itemize}
